...
The first visualization, the bar chart. The audience can quickly judge the debt ratio by observing the length of the bar. The obvious drawback is that the viewer cannot get detailed data from the graph. It's the same problem as a line chart.
